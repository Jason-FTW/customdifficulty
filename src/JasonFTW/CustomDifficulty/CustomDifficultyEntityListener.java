...
class CustomDifficultyEntityListener extends EntityListener {
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        ...
        if (!(e instanceof Player) && e.getLastDamageCause() instanceof EntityDamageByEntityEvent && (edbee = (EntityDamageByEntityEvent)e.getLastDamageCause()).getDamager() instanceof Player && (lastKills = Manager.getLastKills(player = (Player)edbee.getDamager())).length > 0) {
    ...
    public void onEntityTarget(EntityTargetEvent event) {
        ...
        if (e instanceof Wolf && ((Wolf)e).isTamed()) {
            ...
            c = (Creature)e;
            a = CreatureInfo.getAggressiveness((LivingEntity)c);
...
lbl39: // 6 sources:
            ...
            g = (Ghast)e;
            a = CreatureInfo.getAggressiveness((LivingEntity)g);
