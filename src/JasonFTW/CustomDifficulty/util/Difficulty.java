...
public class Difficulty {
	...
	private final HashMap<CdCreatureType, Aggressiveness> aggressivenessDay = new HashMap<CdCreatureType, Aggressiveness>();
	private final HashMap<CdCreatureType, Aggressiveness> aggressivenessNight = new HashMap<CdCreatureType, Aggressiveness>();
	private final HashMap<CdCreatureType, Byte> burnsInSunlight = new HashMap<CdCreatureType, Byte>();
	private final HashMap<CdCreatureType, Double> damage = new HashMap<CdCreatureType, Double>();
	private final HashMap<CdCreatureType, ArrayList<DropItem>> drops = new HashMap<CdCreatureType, ArrayList<DropItem>>();
	private final HashMap<CdCreatureType, Short> health = new HashMap<CdCreatureType, Short>();
	private final HashMap<CdCreatureType, Byte> heightMax = new HashMap<CdCreatureType, Byte>();
	private final HashMap<CdCreatureType, Byte> heightMin = new HashMap<CdCreatureType, Byte>();
	private final HashMap<CdCreatureType, Byte> lightLevelMax = new HashMap<CdCreatureType, Byte>();
	private final HashMap<CdCreatureType, Byte> lightLevelMin = new HashMap<CdCreatureType, Byte>();
	private final HashMap<CdCreatureType, Double> lootMultiplier = new HashMap<CdCreatureType, Double>();
	private final HashMap<CdCreatureType, Double> reward = new HashMap<CdCreatureType, Double>();
	private final HashMap<CdCreatureType, Double> spawnChance = new HashMap<CdCreatureType, Double>();
	private final HashMap<CdCreatureType, ArrayList<Material>> spawnNotOn = new HashMap<CdCreatureType, ArrayList<Material>>();
	private final HashMap<CdCreatureType, ArrayList<Material>> spawnOnlyOn = new HashMap<CdCreatureType, ArrayList<Material>>();
	private final ArrayList<EntityType> spawningCreatureTypes;
	...
	private ArrayList<EntityType> createCreatureTypeArray() {
		ArrayList<EntityType> temp = new ArrayList<EntityType>();
		List<?> input = this.config.getList("global.possibleSpawnCreatures");
		if (input == null) {
			return temp;
		}
		for (Object o : input) {
			EntityType ct = CreatureInfo.getCreatureTypeFromName((String)o);
	...
	public ArrayList<EntityType> getCreatureTypes() {
